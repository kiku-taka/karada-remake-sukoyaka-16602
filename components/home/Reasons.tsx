const reasons = [
  {
    ...
    img: 'https://image.pollinations.ai/prompt/AI%20posture%20analysis%20technology%20medical%20clinic%20professional%20screen%20body%20scan?width=512&height=341&model=flux',
    reverse: false,
  },
  {
    num: '02',
    ...
    img: 'https://image.pollinations.ai/prompt/professional%20chiropractor%20treatment%20skilled%20hands%20japanese%20clinic%20trust?width=512&height=341&model=flux',
    reverse: true,
  },
  {
    num: '03',
    ...
    img: 'https://image.pollinations.ai/prompt/wellness%20aftercare%20stretching%20exercise%20coaching%20healthy%20lifestyle%20calm%20japanese?width=512&height=341&model=flux',
    reverse: false,
  },
  {
    num: '04',
    ...
    img: 'https://image.pollinations.ai/prompt/private%20healing%20room%20japanese%20spa%20aroma%20candle%20wood%20zen%20interior%20calm?width=512&height=341&model=flux',
    reverse: true,
  },
  {
    num: '05',
    ...
    img: 'https://image.pollinations.ai/prompt/shibuya%20tokyo%20street%20urban%20modern%20entrance%20welcoming%20sign%20clinic?width=512&height=341&model=flux',
    reverse: false,
  },
]
